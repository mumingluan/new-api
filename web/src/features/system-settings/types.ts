...
export type SecuritySettings = {
  ...
  TokenRateLimitEnabled: boolean
  TokenRateLimitDurationMinutes: number
  TokenRateLimitCount: number
  TokenRateLimitSuccessCount: number
  TokenRateLimitGroup: string
  TokenDailyRateLimitEnabled: boolean
  TokenDailyRateLimitCount: number
  TokenDailyRateLimitSuccessCount: number
  TokenDailyRateLimitGroup: string
