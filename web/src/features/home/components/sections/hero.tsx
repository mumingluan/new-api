    ...
    <section className='relative z-10 overflow-hidden px-6 pt-24 pb-16 md:pt-32 md:pb-24 lg:pt-36 lg:pb-28'>
      ...
      <div
        className={
          USE_XUANCAT_PAGES
            ? 'mx-auto max-w-3xl'
            : 'mx-auto grid max-w-6xl grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8'
        }
      >
        <div
          className={
        ...
        >
          ...
          >
            {USE_XUANCAT_PAGES
              ? t(
                  'A reliable foundation for your AIGC applications, with one API for leading model providers.'
                )
              : t(
