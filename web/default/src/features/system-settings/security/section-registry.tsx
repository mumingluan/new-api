...
const SECURITY_SECTIONS = [
  ...
  {
    id: 'token-rate-limit',
    titleKey: 'Per-API-key minute rate limit',
    build: (settings: SecuritySettings) => (
      <TokenRateLimitSection
        defaultValues={{
          TokenRateLimitEnabled: settings.TokenRateLimitEnabled,
          TokenRateLimitDurationMinutes: settings.TokenRateLimitDurationMinutes,
          TokenRateLimitCount: settings.TokenRateLimitCount,
          TokenRateLimitSuccessCount: settings.TokenRateLimitSuccessCount,
          TokenRateLimitGroup: settings.TokenRateLimitGroup,
        }}
      />
    ),
  },
  {
    id: 'token-daily-rate-limit',
    titleKey: 'Per-API-key daily rate limit',
    build: (settings: SecuritySettings) => (
      <TokenDailyRateLimitSection
        defaultValues={{
          TokenDailyRateLimitEnabled: settings.TokenDailyRateLimitEnabled,
          TokenDailyRateLimitCount: settings.TokenDailyRateLimitCount,
          TokenDailyRateLimitSuccessCount:
            settings.TokenDailyRateLimitSuccessCount,
          TokenDailyRateLimitGroup: settings.TokenDailyRateLimitGroup,
        }}
      />
    ),
  },
