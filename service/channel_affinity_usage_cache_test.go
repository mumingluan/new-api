...
var channelAffinityTestCounter atomic.Int64

func uniqueChannelAffinityTestKey(t *testing.T, prefix string) string {
	t.Helper()
	return fmt.Sprintf("%s_%s_%d", prefix, t.Name(), channelAffinityTestCounter.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueChannelAffinityTestKey(t, "rule")
	usingGroup := "default"
	keyFP := uniqueChannelAffinityTestKey(t, "fp")
